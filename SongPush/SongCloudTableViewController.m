//
//  SongCloudTableViewController.m
//  SongPush
//
...
@interface SongCloudTableViewController ()

@end

@implementation SongCloudTableViewController
...
- (void)viewDidLoad {
    ...
    [query whereKey: @"typeCloud" equalTo: self.songCloudType];
    NSLog(@"%@", self.songCloudType);
